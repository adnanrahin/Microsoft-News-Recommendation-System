...
class NewsDataTransformerTest extends AnyFunSuite {
  ...
  test("newsDataTransformerMatch") {
    ...
    val expected = News(
      ...
      "lifestyle",
      "lifestyleroyals",
      "The Brands Queen Elizabeth",
      "Prince Charles, and Prince Philip Swear By,Shop the notebooks, jackets, and more that the royals can't live without.",
      "https://assets.msn.com/labs/mind/AAGH0ET.html",
      "[Prince Philip, Duke of Edinburgh,Charles, Prince of Wales,Elizabeth II]",
      "[Q80976,Q43274,Q9682]",
      "[1.0,1.0,0.97]",
      "[P,P,P]",
      "[48.0,28.0,11.0]",
      "[Prince Philip,Prince Charles,Queen Elizabeth]", "", "", "", "", "", ""
    )
